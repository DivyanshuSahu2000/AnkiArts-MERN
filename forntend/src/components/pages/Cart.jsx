...
const Cart = () => {
  ...
  return (
    <div className=" md:px-23  sm:px-10 px-5 items-center sm:flex-col py-8">
      ...
      {cart.length == 0 ? (
        ...
        <div className="item_summary flex flex-col md:flex-row gap-2">
          <div className="itemss p-4 bg-amber-50 md:w-3/4 rounded-lg border border-gray-400 shadow-[0_0px_25px_rgba(0,0,0,30.7)] ">
            {" "}
